...
import xn.bwie.com.yunifang.base.BaseDate;
import xn.bwie.com.yunifang.bean.DetailBean;
import xn.bwie.com.yunifang.bean.GoodsXiang;
import xn.bwie.com.yunifang.bean.SqlBean;
import xn.bwie.com.yunifang.fragment.Cart_Fragment;
import xn.bwie.com.yunifang.sql.sqlDao;
import xn.bwie.com.yunifang.utils.CommonUtils;
import xn.bwie.com.yunifang.utils.ImageLoaderUtils;
import xn.bwie.com.yunifang.view.MyListView;
import xn.bwie.com.yunifang.view.MyRoolViewPagerNoScoll;
import xn.bwie.com.yunifang.view.MyScollView;
import xn.bwie.com.yunifang.view.ShowingPage;
...
public class DetailActivity extends AppCompatActivity implements View.OnClickListener, MyScollView.OnScrollListener {
    ...
    private void Goods_lv_Adapter(final DetailBean detailBean, int view, int tag) {
        if(tag==goodsGoods){
            ...
            //lv赋适配器
            goods_lv.setAdapter(new com.zhy.adapter.abslistview.CommonAdapter<GoodsXiang>(DetailActivity.this, R.layout.goodsxiangimg,goods_list) {
