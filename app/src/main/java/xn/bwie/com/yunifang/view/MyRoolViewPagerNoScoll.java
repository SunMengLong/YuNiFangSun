 ...
 */
public class MyRoolViewPagerNoScoll extends ViewPager {
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            //获取当前所在的页码
            int currentItem = MyRoolViewPagerNoScoll.this.getCurrentItem();
            currentItem++;
            MyRoolViewPagerNoScoll.this.setCurrentItem(currentItem);
    ...
    public MyRoolViewPagerNoScoll(Context context) {
        super(context);
        init();
    }

    public MyRoolViewPagerNoScoll(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
